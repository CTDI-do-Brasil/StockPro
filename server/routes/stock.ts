...
stockRouter.get('/bootstrap', async (req: Request, res: Response) => {
  try {
    ...
    let formattedCategories = categoriesRes.rows.map(row => ({
      id: row.id,
      name: row.name,
      department: row.department,
    ...
    if (formattedCategories.length === 0) {
      const defaultCats = [
        { id: 'cat-ti-01', name: 'Hardware & Equipamentos', department: 'TI', subcategories: ['Notebooks', 'Monitores', 'Desktops', 'Servidores', 'Periféricos'], description: 'Equipamentos de informática e computação' },
        { id: 'cat-ti-02', name: 'Redes & Infraestrutura', department: 'TI', subcategories: ['Switches', 'Roteadores', 'Cabos de Rede', 'Patch Cords', 'Racks & Organizadores', 'Conectores RJ45'], description: 'Equipamentos e insumos para conectividade e infraestrutura de rede' },
        { id: 'cat-ti-03', name: 'Acessórios & Cabos', department: 'TI', subcategories: ['Cabos HDMI/DisplayPort', 'Adaptadores', 'Fontes & Carregadores', 'Teclados & Mouses', 'Filtros de Linha'], description: 'Cabos de vídeo, energia e adaptadores diversos' },
        { id: 'cat-ti-04', name: 'Armazenamento & Memória', department: 'TI', subcategories: ['SSDs M.2 / SATA', 'Memórias RAM', 'HDs Externos', 'Pendrives'], description: 'Dispositivos de armazenamento e expansão de memória' },
        { id: 'cat-ti-05', name: 'Impressão & Suprimentos', department: 'TI', subcategories: ['Toners', 'Cartuchos', 'Etiquetas Térmicas', 'Fitas de Rotuladora'], description: 'Insumos e suprimentos para impressoras e rotuladoras' },
        { id: 'cat-ti-06', name: 'Geral', department: 'TI', subcategories: ['Diversos'], description: 'Itens diversos de TI' },
        { id: 'cat-eng-01', name: 'Instrumentação & Medição', department: 'ENGENHARIA', subcategories: ['Multímetros Digitais', 'Osciloscópios', 'Alicates Amperímetros', 'Calibradores de Processo', 'Termovisores'], description: 'Instrumentos calibrados e equipamentos de bancada técnica' },
        { id: 'cat-eng-02', name: 'Automação & CLP', department: 'ENGENHARIA', subcategories: ['CLPs & CPUs', 'Módulos de E/S', 'IHMs Touchscreen', 'Inversores de Frequência', 'Soft-Starters'], description: 'Componentes de controle lógico programável e automação fabril' },
        { id: 'cat-eng-03', name: 'Sensores & Transmissores', department: 'ENGENHARIA', subcategories: ['Sensores Ópticos', 'Sensores Indutivos', 'Sensores Capacitivos', 'Transmissores de Pressão', 'Termopares / PT100'], description: 'Sensores industriais para detecção e telemetria' },
        { id: 'cat-eng-04', name: 'Componentes Eletrônicos & Painel', department: 'ENGENHARIA', subcategories: ['Relés de Segurança', 'Fontes Chaveadas 24VDC', 'Bornes & Conectores', 'Fusíveis Industriais'], description: 'Módulos de segurança e componentes de comando' },
        { id: 'cat-eng-05', name: 'Geral', department: 'ENGENHARIA', subcategories: ['Diversos'], description: 'Itens diversos de Engenharia' },
        { id: 'cat-man-01', name: 'Ferramentas Manuais & Elétricas', department: 'MANUTENCAO', subcategories: ['Parafusadeiras & Furadeiras', 'Chaves Combinadas/Allen', 'Alicates Diversos', 'Serras & Discos', 'Torquímetros'], description: 'Ferramental para oficina mecânica e elétrica' },
        { id: 'cat-man-02', name: 'Mecânica, Rolamentos & Vedações', department: 'MANUTENCAO', subcategories: ['Rolamentos Rígidos de Esferas', 'Correias & Polias', 'Retentores & Gaxetas', 'Acoplamentos Flexíveis', 'Mancais'], description: 'Peças de desgaste mecânico, transmissão e vedação' },
        { id: 'cat-man-03', name: 'Elétrica & Iluminação', department: 'MANUTENCAO', subcategories: ['Disjuntores Termomagnéticos', 'Contatores & Relés Térmicos', 'Lâmpadas & Refletores LED', 'Cabos Flexíveis & Barramentos'], description: 'Materiais elétricos industriais e prediais' },
        { id: 'cat-man-04', name: 'Pneumática & Hidráulica', department: 'MANUTENCAO', subcategories: ['Válvulas Solenoide', 'Cilindros Pneumáticos', 'Conexões Instantâneas', 'Mangueiras PU/Nylon', 'Manômetros'], description: 'Válvulas, atuadores e conexões para linhas de ar comprimido e fluídos' },
        { id: 'cat-man-05', name: 'EPIs & Segurança do Trabalho', department: 'MANUTENCAO', subcategories: ['Luvas de Proteção', 'Óculos de Segurança', 'Protetores Auriculares', 'Capacetes & Botinas', 'Travamentos LOTO'], description: 'Equipamentos de proteção individual e sinalização' },
        { id: 'cat-man-06', name: 'Geral', department: 'MANUTENCAO', subcategories: ['Parafusos & Porcas', 'Lubrificantes & Desengripantes', 'Fitas Adesivas/Isolantes'], description: 'Insumos gerais de Manutenção' }
      ];
      ...
      for (const cat of defaultCats) {
        try {
          await pool.query(
            ...
            [cat.id, cat.name, cat.department, JSON.stringify(cat.subcategories), cat.description]
          );
        } catch (e) {}
      }
      formattedCategories = defaultCats;
    }
